...
class CodeInfo extends Model
{
    ...
    public function codeLoad($params)
    {
        ...
        if ($degree == 1) {
            #1차 코드 불러오는 함수
            $degree_first_sql = "
                select code_num1, code_name, is_necessary from {$this->table_name} where code_num2 = '' and code_use = 'Y'
            ";
            ...
            #2차 코드 불러오는 함수
            $degree_second_sql = "select code_num2, code_name, is_necessary 
            from {$this->table_name} where code_num1 = " . $code_num1 . " and code_num2 <> '' and code_num3 = '' and code_use = 'Y'";
            ...
            $degree_third_sql = "select code_num3, detail, is_necessary 
    ...
    {
        $sql = "select code_num1, code_num2, code_name from rams.codem
            where code_num1 = '" . $code_num1 . "'
            and code_num2 <> ''";
