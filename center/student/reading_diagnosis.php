...
<body class="size-14">
    ...
    <main style="min-height: 79vh;">
        <div class="container-fluid">
            <div class="card border-left-primary h-100 shadow mt-2 mb-2 ps-1 pe-1">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="card border-left-primary shadow mt-2 mb-2">
                            <!-- <div class="card-header">
                                <h6 class="card-title"><?php //echo $StudentName; 
                                                        ?> 님 분석결과</h6>
                            </div> -->
                            <div class="card-body">
                                <!-- 2023-07-27 대표님 요청 데이터 쌓이기 전까지 서비스 안함. 평가요소로 신뢰성 확보가 우선 / 도서 주제별 세부 분류 권수만 표시 -->
