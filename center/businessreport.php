...
if (!empty($_SESSION['logged_no'])) {
    $report_setting = $reportController->reportSettingPageLoad($_SESSION['center_idx'], $_SESSION['logged_no']);
}
?>
                    ...
                    <div class="form-inline me-2">
                        <div class="form-floating">
                            ...
                            ?>
                                ...
                                <label for="selEmployee">작성자</label>
                            <?php
                            }
                            ?>
                        </div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-6">
                        <p>이전 작성 내용</p>
                        <?php
                        $pre_report_data = $reportController->reportContentsPageLoad($_SESSION['center_idx'], $_SESSION['logged_no']);
