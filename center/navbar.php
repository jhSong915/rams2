...
<nav class="navbar navbar-expand navbar-dark bg-dark">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="/center/"><img class="img rounded-circle" src="/img/logo.png" /><span class="align-middle ms-1">리딩엠</span></a>
    <!-- Navbar Grid-->
...
<script>
    ...
    var amt = document.getElementById("txtCharge");
