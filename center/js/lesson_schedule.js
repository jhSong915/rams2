...
$(document).ready(function () {
    ...
    $("#standardLessonMonth, #selLessonWeek").change(function () {
        ...
        var targetLextMonth = moment(standardMonth).add(Number(selLessonWeek * 7) - 1, 'd').format('YYYY-MM-DD');
    ...
    $("#btnLessonMove").click(function () {
        ...
        + moment(standardMonth).add(Number(selLessonWeek * 7) , 'd').format('YYYY-MM-DD') + " ~ " + moment(targetMonth).add(Number(selLessonWeek * 7), 'd').format('YYYY-MM-DD') )) {
            $.ajax({
                url: '/center/ajax/lessonScheduleControll.ajax.php',
                dataType: 'JSON',
                type: 'POST',
