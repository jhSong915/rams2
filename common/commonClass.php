...
class permissionCmp extends DBCmp
{
    ...
    public function chkIp2Country($target_ip)
    {
        $sql = "SELECT country_code FROM ip_countryT WHERE dbo.IPAddressAsNumber({$target_ip}) BETWEEN dbo.IPAddressAsNumber(start_ip) AND dbo.IPAddressAsNumber(end_ip)";
