...
<body>
    ...
    $grade = $_GET['grade'];
    if (empty($grade)) {
        echo "<script>alert('학년 정보가 없습니다.'); window.close();</script>";
    }
    ?>
    <div class="container">
        <div class="row">
                        ...
                        <div class="input-group justify-content-end mb-1">
                            <div class="form-inline">
                                <div class="form-floating">
                                    <select id="selGrade1" class="form-select" disabled>
                                        <option value="1" <?= $grade == "1" ? "selected" : "disabled" ?>>1학년</option>
                                        <option value="2" <?= $grade == "2" ? "selected" : "disabled" ?>>2학년</option>
                                        <option value="3" <?= $grade == "3" ? "selected" : "disabled" ?>>3학년</option>
                                        <option value="4" <?= $grade == "4" ? "selected" : "disabled" ?>>4학년</option>
                                        <option value="5" <?= $grade == "5" ? "selected" : "disabled" ?>>5학년</option>
                                        <option value="6" <?= $grade == "6" ? "selected" : "disabled" ?>>6학년</option>
                                    </select>
                ...
                <div class="card border-left-primary shadow mt-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group justify-content-end mb-1">
                            <div class="form-inline">
                                <div class="form-floating">
                                    <select id="selGrade2" class="form-select" disabled>
                                        <option value="1" <?= $grade == "1" ? "selected" : "disabled" ?>>1학년</option>
                                        <option value="2" <?= $grade == "2" ? "selected" : "disabled" ?>>2학년</option>
                                        <option value="3" <?= $grade == "3" ? "selected" : "disabled" ?>>3학년</option>
                                        <option value="4" <?= $grade == "4" ? "selected" : "disabled" ?>>4학년</option>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#btnSubmmit1").click(function() {
                ...
                location.href = "/reading_analysis/index3_reading.php?grade=" + grade;
            });
            $("#btnSubmmit2").click(function() {
                var grade = $("#selGrade2").val();
                location.href = "/reading_analysis/index3_writing.php?grade=" + grade;
            });
        });
    </script>
</body>
