                                ...
                                <div class="card-body">
                                    <div class="container">
                                        <div class="input-group justify-content-end mb-2">
                                            <div class="form-inline me-2">
                                                <div class="form-floating">
                                                    <select id="sel_centerlist" class="form-select" onchange="receiptItemLoad()">
                                                        <?php
                                                        $centerList = $infoClassCmp->searchFranchisee();
                                                        if (!empty($centerList)) {
                                                            foreach ($centerList as $key => $val) {
                                                    ...
                                                    <label for="sel_centerlist" class="form-label">수납항목조회센터</label>
                                                </div>
                                            </div>
                                            <div class="form-inline me-2">
                                                <div class="form-floating">
                                                    <select id="sel_center2" class="form-select">
                                                        <?php
                                                        $centerList = $infoClassCmp->searchFranchisee('adm');
                                                        if (!empty($centerList)) {
                                                            foreach ($centerList as $key => $val) {
                                                                echo "<option value=\"" . $val['franchise_idx'] . "\">" . $val['center_name'] . "</option>";
                                                            }
                                                    ...
                                                    <label for="sel_center2" class="form-label">배포대상센터</label>
                                                </div>
                                            </div>
